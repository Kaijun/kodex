...
Install or upgrade the current macOS arm64 or Linux (x86_64, arm64) release without a local Rust
toolchain:
...
Before publication, the release jobs verify the aliased executable
names, Linux ELF / macOS ad-hoc code-signature properties, CLI usage, and home environment
